...
GUI_TabMain GUI_TabMain_create(GUI_TabMain_Config* config) {
    ...
    lv_obj_set_style_bg_color(tabMain, lv_color_hex(GUI_TABVIEW_TABMAIN_BGCOLOR), 0);
    lv_obj_set_style_bg_opa(tabMain, LV_OPA_COVER, 0);
    lv_obj_set_style_bg_color(tabHistory, lv_color_hex(GUI_TABVIEW_TABHISTORY_BGCOLOR), 0);
    lv_obj_set_style_bg_opa(tabHistory, LV_OPA_COVER, 0);
    lv_obj_set_style_bg_color(tabSettings, lv_color_hex(GUI_TABVIEW_TABSETTINGS_BGCOLOR), 0);
