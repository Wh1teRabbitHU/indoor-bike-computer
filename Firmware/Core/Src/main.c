...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, DISPLAY_D13_Pin|DISPLAY_D14_Pin|DISPLAY_D15_Pin|DISPLAY_D16_Pin
                          |DISPLAY_D17_Pin|DISPLAY_RESET_Pin|ESP32_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, DISPLAY_D00_Pin|DISPLAY_D01_Pin|DISPLAY_D02_Pin|DISPLAY_D03_Pin
                          ...
                          |DISPLAY_D12_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DISPLAY_RD_Pin|DISPLAY_WR_Pin|DISPLAY_DC_Pin|DISPLAY_CS_Pin
                          |GAUGE_ALERT_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = DISPLAY_D13_Pin|DISPLAY_D14_Pin|DISPLAY_D15_Pin|DISPLAY_D16_Pin
                          |DISPLAY_D17_Pin|DISPLAY_RESET_Pin|ESP32_EN_Pin;
  ...
  /*Configure GPIO pins : DISPLAY_D00_Pin DISPLAY_D01_Pin DISPLAY_D02_Pin DISPLAY_D03_Pin
                           ...
                           DISPLAY_D08_Pin DISPLAY_D09_Pin DISPLAY_D10_Pin DISPLAY_D11_Pin
                           DISPLAY_D12_Pin */
  GPIO_InitStruct.Pin = DISPLAY_D00_Pin|DISPLAY_D01_Pin|DISPLAY_D02_Pin|DISPLAY_D03_Pin
                          |DISPLAY_D04_Pin|DISPLAY_D05_Pin|DISPLAY_D06_Pin|DISPLAY_D07_Pin
                          |DISPLAY_D08_Pin|DISPLAY_D09_Pin|DISPLAY_D10_Pin|DISPLAY_D11_Pin
                          |DISPLAY_D12_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pins : DISPLAY_RD_Pin DISPLAY_WR_Pin DISPLAY_DC_Pin DISPLAY_CS_Pin
                           GAUGE_ALERT_Pin */
  GPIO_InitStruct.Pin = DISPLAY_RD_Pin|DISPLAY_WR_Pin|DISPLAY_DC_Pin|DISPLAY_CS_Pin
                          |GAUGE_ALERT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
